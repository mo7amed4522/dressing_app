...
class LikUnLikBtnWidgetAnimation extends StatelessWidget {
  ...
  final bool like;
  const LikUnLikBtnWidgetAnimation({super.key, required this.like, required this.onLikeBtnTap});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CollectionScreenControllerIMP>(
      init: CollectionScreenControllerIMP(),
      builder: (controller) => InkWell(
        borderRadius: BorderRadius.circular(50),
        onTap: () {
          onLikeBtnTap();
          controller.controllerAnimation.reverse().then((value) => controller.controllerAnimation.forward());
        },
        child: Container(
          height: 50,
          width: 50,
          ...
          child: Center(
            child: Container(
              ...
              child: like
                  ? ScaleTransition(
                      scale: Tween(begin: 0.7, end: 1.0).animate(CurvedAnimation(parent: controller.controllerAnimation, curve: Curves.easeOut)),
