...
class CustomCardLoveViewCollectionWidget extends StatelessWidget {
  const CustomCardLoveViewCollectionWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FavorietBottomNvaBarWidgetControllerIMP>(
      init: FavorietBottomNvaBarWidgetControllerIMP(),
      builder: (controller) => controller.favouritData == null
          ? Container(margin: EdgeInsets.symmetric(horizontal: 10.sp), alignment: Alignment.center, child: Text('noCollection'.tr, style: Theme.of(context).textTheme.displayLarge, textAlign: TextAlign.center))
          : Container(
              padding: EdgeInsets.only(top: 7.h),
              margin: EdgeInsets.symmetric(horizontal: 5.sp),
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20.sp)),
              child: ListView.separated(
                itemCount: controller.favouritData!.length,
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    controller.favouritData![index].photo!,
                                    width: 10.w,
                                    height: 17.h,
                                    fit: BoxFit.cover,
                              ...
                              Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(controller.favouritData![index].collectionName!, style: Theme.of(context).textTheme.labelMedium),
                                  AnimatedRatingStars(
                                    initialRating: controller.favouritData![index].rate!.toDouble(),
                                    minRating: 0.0,
                                    maxRating: 5.0,
